  ...
  return (
    <>
      ...
      <section className="bg-gradient-to-br from-sky-50 to-teal-50 py-16 px-4 text-center">
        <h1 className="text-4xl font-bold text-gray-900 mb-3">Contact Phoenix</h1>
        <p className="text-gray-500 max-w-xl mx-auto">
          Book an appointment at Phoenix | The Physiotherapy Clinic or reach
          out with any questions. We&apos;re here to help you on your path to
          recovery.
        </p>
      </section>
              ...
              {info.map((i) => (
                <div key={i.label} className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">{i.value}</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            {submitted ? (
              <div className="bg-green-50 border border-green-200 rounded-2xl p-8 text-center">
                ...
                <p className="text-green-700">
                  Thank you, {form.name}. We&apos;ll confirm your appointment
